...
background-image:url('lib11.jpg');}
#log{
position:absolute;
display:block;
height:50px;
...
<h2 style='text-align:center;color:white;font-family:comic sans ms;'>(Please click on 'BOOK DETAILS' to enter the name of the book to be added then click on 'Add' button to add it)</h2>
