...
window.alert("Hello here is a ludo game for you");
function myfunction()
{ 
if(daan==0)
...
document.getElementById('tias1').innerHTML=x;
if((i%2==0)&&(x!=6))
...
document.getElementById("lockerA").innerText="2A";
 ...
 else if((document.getElementById("lockerB").innerText=="1B")&&(document.getElementById('tias1').innerText=="6"))
 {flagB=1;
  daan=0;
