...
<h2 style='text-align:center;color:white;font-family:comic sans ms'>Please click on 'Return' to return book and click on 'Issue' to issue book</h2>
<?php
...
$.ajax({
            ...
            success: function( result )  {
                   ...
                   if((document.getElementById(x+'m').innerHTML==0))
                      alert("Sorry!!Book cannot be issued!!Stock empty");  
